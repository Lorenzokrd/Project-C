    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="row">
                ...
                @if($recommendedRestaurant->approved == 1)
                <div class="col col-12 col-sm-6 col-lg-4 restaurant-grid-item" onclick="document.location='/{{$recommendedRestaurant->name}}';">
                        <div class="restaurant-card" style="background-image:url({{ asset('storage/'.str_replace('public/', '', $recommendedRestaurant->image)) }});">
                            <div class="restaurant-name">
                                <p><i class="far fa-star" aria-hidden="true"></i> {{$recommendedRestaurant->name}}</p>
                            </div>
                            <div class="status restaurant-status-recommended">
                                <p>Aanbevolen voor jou</p>
                            </div>
                            <div class="restaurant-info">
                                <div class="restaurant-score"><?php Makestars($recommendedRestaurant->rating) ?></div>
                                <p class="price"><i class="fas fa-shopping-basket"></i> Min. €{{ str_replace('.', ',', $recommendedRestaurant->min_order_price)}}</p>
                                @if($recommendedRestaurant->avg_delivery_time)
                                <p class="time"><i class="far fa-clock"></i> {{$recommendedRestaurant->avg_delivery_time}} min</p>
                                @else
