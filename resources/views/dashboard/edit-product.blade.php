  ...
  <div class="success-popup" id="success-popup"><i class="far fa-check-circle"></i> {{session('message')}}</div>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group">
                <label for="productName">Product naam</label>
                <input type="input" class="form-control" name="productName" aria-describedby="emailHelp" placeholder="Product naam" value='{{$product->name}}'>
            </div>
            <div class="form-group">
                <label for="productDesc">Product beschrijving</label>
                <input type="input" class="form-control" name="productDesc" placeholder="Product Beschrijving" value='{{$product->description}}'>
            </div>
            <div class="form-group form-check">
                @if($product->productRating == null)
                <input type="checkbox" class="form-check-input" name="productRating" >
